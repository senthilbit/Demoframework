...
# @author Akshay
  ...
  Scenario Outline: Insert WorkBook
    ...
    * header Cookie =  testCooke
    And request {"index":"workbook","field":"user_id","value":<username>}
    When method POST
    Then status 201
    And print response
    ...
    * header Accept = 'application/json'
    * header Cookie =  testCooke
    And request {"index":"workbook","doc":{"name":"#(random)","user_id":<username>,"user_email":<username>,"shared_with":[],"remote_datasource":"Elastic"}}
    When method post
    Then status 201
    And print response
    * def Id = response._id
    ...
    * header Cookie =  testCooke
    ...
    Examples:
    | username | password |
    |  amandeep.chauhan@thedigitalgroup.com          |   tdg@1234        |
    |   user1@gmail.com                              |    User@123       |
    |   user2@gmail.com                              |     User@123      |
    |   user3@gmail.com                              |    User@123       |
    |   user4@gmail.com                              |     User@123      |
    |   user5@gmail.com                              |     User@123      |
