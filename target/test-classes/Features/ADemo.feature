...
# @author Akshay
  ...
  Background:
    ...
    * url baseUrl
    * configure ssl = true
    * def result = { "username":"hfdhjdhf", "password":"12345dfdsaf" }
  ...
  Scenario: Insert WorkBook
    ...
    * header Cookie =  testCooke
    And request {"index":"workbook","doc":{"name":"#(random)","user_id":"hfdhjdhf","user_email":"hfdhjdhf","shared_with":[],"remote_datasource":"Elastic"}}
    When method post
    Then status 201
    And print response
    * def Id = response._id
